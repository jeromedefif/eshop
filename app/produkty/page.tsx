...
export default async function PublicProductsPage() {
    ...
    return (
        <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,_#dbeafe,_transparent_32%),linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] text-slate-900">
            ...
            <section className={`${SITE_CONTAINER_CLASS} pb-10 pt-12 sm:pt-16`}>
            ...
            <section className={`${SITE_CONTAINER_CLASS} py-8`} aria-labelledby="categories-heading">
            ...
            {featuredProducts.length > 0 && (
                <section className={`${SITE_CONTAINER_CLASS} py-14`} aria-labelledby="featured-heading">
